...
namespace uLoader
{
    partial class HHandlerQueue : ASUTP.Helper.HHandlerQueue
    {
        ...
        public enum StatesMachine
        {
            ...
            , LIST_SRC_GROUP_SIGNAL_ITEMS //Список сигналов в группе сигналов (источник) /*5*/
            ...
            , LIST_DEST_GROUP_SOURCE_PROP //Список параметров соединения источников в группе источников (назначение) /*10*/
            ...
            , OBJ_DEST_GROUP_SOURCES //Объект группы источников (назначение) /*15*/
            ...
            , TIMER_WORK_UPDATE //Период обновления панели "Работа" /*20*/
            ...
            , COMMAND_RELAOD_GROUP_SOURCES //Команда для выгрузки/загрузки библиотеки - инициатива пользователя /*25*/
